...
<a href="mon espace.html"> Retour</a>

<p>ARTICLE 1 – ACCEPTATION DES CONDITIONS GÉNÉRALES D'UTILISATION
...
Les CGU s'appliquent concomitamment (i) aux Conditions Particulières qui seront notifiées aux Utilisateurs lors de leur inscription à certains Services (par exemple des conditions générales de vente, règlement de jeux-concours, etc.), (ii) à la Charte Données Personnelles et Cookies, et (iii) à toute déclinaison ou extension du Site sur les réseaux sociaux et/ou communautaires existants ou à venir.
...
L’Editeur peut à tout moment modifier les termes des CGU. L’Utilisateur est expressément informé que la version en vigueur est celle qui est mise en ligne à l’adresse URL https://www.public.fr/Mentions-Legales-et-CGU à la date de son accès à l’un quelconque des Services, ce que l’Utilisateur reconnaît et accepte sans restriction, s’engageant à s’y référer systématiquement lors de chaque connexion.<br><br>
...
L’accès à certains Services est conditionné à l’inscription au site www.public.fr (ci-après « Public »). Public est un Service gratuit et personnel permettant à l'Utilisateur inscrit de bénéficier d'un Service de gestion de son compte Public et des Services qui y sont associés, tels que décrits dans les Conditions Particulières des CGU.

Pour créer un compte Public, l’Utilisateur doit :

Soit choisir un pseudo puis remplir un formulaire d’inscription en fournissant des informations personnelles, dont notamment le nom, le prénom, l'adresse mail, un mot de passe, qui lui permettront ensuite de s’identifier et de lui faciliter l’accès ;
Soit être inscrit à l’un des sites tiers indiqués par l’Editeur et utiliser ses identifiants de connexion.
Ces informations personnelles sont collectées et conservées avec le consentement de l'Utilisateur et feront l'objet d'un traitement conformément à la loi n°78-17 du 6 janvier 1978 modifiée relative à l’informatique, aux fichiers et aux libertés, et du Règlement européen n°2016/679 du 27 avril 2016 relatif à la protection des personnes physiques à l’égard du traitement des données à caractère personnel et à la libre circulation de ces données (ci-après la « Règlementation applicable »). Les données des mineurs, en fonction de leur âge, sont collectées et conservées avec le consentement de leurs parents ou titulaires de l’autorité parentale, en plus du leur.

Les mineurs sont admis à s’inscrire à Public à la condition expresse qu’ils aient préalablement obtenu de leur(s) parent(s) (ou de la personne exerçant l’autorité parentale) l’autorisation pour utiliser le ou les Services. L’Editeur se réserve le droit d’en demander la justification écrite à tout moment et de procéder à toutes vérifications ainsi que de supprimer l’inscription de l’enfant mineur qui ne remettrait pas immédiatement ladite justification. Les parents (ou titulaire(s) de l’autorité parentale) acceptent en conséquence d’être garants du respect de l’ensemble des dispositions des CGU et, le cas échéant, des Conditions Particulières d’Utilisation de certains Services. Ils reconnaissent qu’ils leur incombent de surveiller l’utilisation faite par les enfants mineurs des Services proposés sur le Site.
...
Le pseudo et mot de passe (ci-après les « Identifiants ») permettent à chaque Utilisateur de s'identifier et de se connecter aux Services. Ils sont personnels et confidentiels et ne peuvent être modifiés que sur demande de son titulaire ou à l’initiative de l’Editeur.
...
Chaque Utilisateur est en conséquence seul responsable de l’utilisation du ou des Service(s) faite sous son identification. Toute connexion ou transmission de données effectuée en utilisant les Identifiants sera réputée avoir été effectuée par l’Utilisateur et sous sa responsabilité exclusive. En conséquence l’Editeur ne pourra être tenu responsable de l'utilisation frauduleuse des Identifiants de l'Utilisateur par un tiers.<br><br>

ARTICLE 3 – ACCÈS AUX SERVICES ET SUSPENSION DES SERVICES

3.1 Disponibilité du Site et des Applications

L’Editeur s’engage à faire ses meilleurs efforts pour que l'accès et le fonctionnement du Site et des Applications soient assurés 24 heures sur 24 (24H/24) et 7 jours sur 7 (7J/7) sans interruption.

Toutefois, l’Editeur ne peut voir sa responsabilité recherchée en cas d'indisponibilité temporaire du Site, des Applications et des Services (i) en cas de maintenance du Site, des Applications ou des serveurs sur lesquels ils sont hébergés, (ii) en cas de survenance d'événements extérieurs à sa volonté et à son contrôle, ou (iii) en raison de cas de force majeure. L’Editeur informera au préalable l'Utilisateur de l'indisponibilité si l'événement à l'origine de l'indisponibilité est prévisible.

3.2 Suspension de l'accès

L’Editeur se réserve le droit de suspendre l'accès aux Services (i) en cas de perte, vol et/ou utilisation frauduleuse des Identifiants de l'Utilisateur dont ce dernier l'a informé, (ii) en cas d'utilisation non conforme aux dispositions des présentes, ou (iii) en cas d'opérations de maintenance. La responsabilité de l’Editeur ne peut être engagée en raison de ces interruptions et des conséquences qui peuvent en découler pour l’Utilisateur.<br><br>
...
Lors de son inscription et à l’occasion de toute utilisation des différents Services auxquels le compte Public donne accès, tout Utilisateur s’engage tant à l’égard de l’Editeur que des autres Utilisateurs inscrits et de manière générale auprès de tout tiers, à :
...
Avertir l’Editeur de tous les dysfonctionnements logiques et techniques qu’il pourrait constater et toutes les anomalies qu’il pourrait découvrir, telles en particulier les intrusions non autorisées au sein de son compte Public.
En cas de non-respect des principes énoncés ci-dessus, l’Editeur se réserve la possibilité de suspendre ou refuser l’accès, sans préavis ni indemnité, de façon temporaire ou définitive, à tout ou partie des Services.

Tout Utilisateur qui s’inscrit et qui utilise les différents Services associés à son compte Public, en ce compris notamment la publication de données à caractère personnel le concernant, reconnaît qu’il y procède sous son entière et exclusive responsabilité, en ce compris la responsabilité du fait de la diffusion et de la reproduction des informations, et du fait des conséquences qui en découlent vis-à-vis des autres Utilisateurs et/ou des tiers intéressés.

4.2 Engagements quant aux Commentaires publiés par l'Utilisateur

Le Site, les Applications et les informations qui y sont publiées sont réservés : 

        i.           A la consultation des informations au moyen du système de traitement automatisé de données de l’Editeur ;

      ii.           Aux utilisations strictement réservées à l’usage privé et non marchand de l’Utilisateur et non destinées à une utilisation collective, gratuite ou payante.

L’Utilisateur déclare et reconnaît que toutes les informations, données, textes, logiciels, musiques, sons, photographies, images, vidéos, messages ou tout autre contenu qu’il émet le sont sous son entière et seule responsabilité.
...
Le droit de la propriété intellectuelle applicables aux créations multimédias, aux logiciels, aux textes, aux bases de données, aux articles, aux photos, aux vidéos, aux marques déposées, aux bases de données, aux images de toute nature ;
...
De diffuser des propos diffamatoires, abusifs, harcelant ou menaçant quiconque, ou en violation des droits d’autrui ;
De faire l’apologie des crimes contre l’humanité, d’inciter à la haine raciale ou à la pédophilie ;
...
D’entraver les Services associés au compte Public ;
...
De reproduire et/ou utiliser la marque, la dénomination sociale, le logo ou tout signe distinctif et de manière générale toute donnée de quelque nature qu’elle soit, rédactionnelle, graphique ou autre de l’Editeur, d’un autre Utilisateur ou d’un tiers ;
...
LDF, Editeur du Site, a la qualité d’hébergeur s’agissant des Commentaires postés par les internautes sur le Site.

Conformément aux dispositions de la loi sur la Confiance dans l’Economie Numérique du 21 juin 2004, la responsabilité de l’Editeur concernant les Services proposés est celle d’un hébergeur de contenus, ces Services, permettant aux Utilisateurs de poster des commentaires pour chaque article publié par la rédaction de Public (ci-avant et ci-après désignés par les "Commentaires"). Les Commentaires ne relèvent pas de l’activité éditoriale de l’Editeur qui ne fait que mettre à disposition des Utilisateurs ce Service et en stocker le contenu sur son propre Site et ses Applications.
...
Quels que soient les moyens de contrôle que l’Editeur met en œuvre, il est entendu qu’en raison du volume des informations publiées, l’Editeur n’est pas soumis à une obligation générale de surveiller les informations qu'il stocke, ni à une obligation générale de rechercher des faits ou des circonstances révélant des activités illicites, ni à une obligation de garantie concernant l’exactitude, la probité ou l'honnêteté des informations publiées par les Utilisateurs.

L’Editeur se réserve le droit d’insérer ou d’autoriser tout tiers à insérer des messages publicitaires, promotionnels et/ou de parrainage dans tout espace des Services, ce toutefois sans aucune intervention sur les Commentaires. Ainsi, les espaces vidéo intégrés dans l’outil de lecture des vidéos sont gérés par l’Editeur. Ces espaces sont indépendants et ne peuvent en aucun cas remettre en cause la qualification d'intermédiaire technique de l’Editeur et le régime de responsabilité en découlant.<br><br>

ARTICLE 6 - DONNEES A CARACTERE PERSONNEL ET COOKIES

6.1 Données personnelles

Lors de l’utilisation des Services par l’Utilisateur, des données à caractère personnel sont susceptibles d’être collectées et traitées en vue de permettre l’accès aux Services à des fins d’identification, d’administration et de gestion technique des Services ainsi qu’à des fins de statistiques et de prospection commerciale, conformément au cadre légal applicable.
...
Par voie postale : 9 place Marie-jeanne Bassot - 92300 Levallois-Perret

Par téléphone : 01 41 34 60 00

Par voie électronique : contact@public.fr

 

L’Utilisateur peut par ailleurs contacter le délégué à la protection des données personnelles à l’adresse suivante : DelegueProtectionDonnees@lagardere-active.com.
...
L’Utilisateur est invité à prendre connaissance de la Charte sur les Données Personnelles et Cookies disponible sur le Site à l’adresse suivante : https://www.public.fr/Charte-donnees-personnelles-et-cookies.
...
Pour plus d’information concernant les cookies, l’Editeur renvoie à sa Charte sur les données personnelles et cookies disponible sur le Site à l’adresse suivante : https://www.public.fr/Charte-donnees-personnelles-et-cookies.<br><br>
...
Les CGU ne s’appliquent pas aux contenus et offres des partenaires, il est donc recommandé aux Utilisateurs de prendre connaissance des conditions générales d’utilisation et des conditions générales de vente des sites des partenaires.<br><br>
...
9.1 Contenus du Site, des Applications et des Services

Hachette Filipacchi Presse est titulaire du nom de domaine : https://www.public.fr

Le Site, les Applications ainsi que les éléments qui les composent sont la propriété exclusive de Hachette Filipacchi Presse, de LDF et de leurs propriétaires respectifs, seuls habilités à utiliser les droits de propriété intellectuelle et droits de la personnalité y afférents, notamment marques, modèles, droits d'auteur et droits à l'image, à titre originaire ou par l'effet d'une licence ou d'une autorisation expresse. 

L'ensemble des éléments du Site et des Applications édité par LDF (notamment la structure, tous les textes, photos, vidéos, données, affiches, logos, marques et autres éléments reproduits) est réservé et protégé par le droit de la propriété intellectuelle, notamment les droits d'auteur, droits voisins, et droit des marques.
...
Etre le propriétaire ou le titulaire des droits et/ou autorisations nécessaires relatifs aux droits d’auteur, droits de la personnalité ou autres droits de propriété intellectuelle et/ou industrielle éventuellement attachés à son Commentaire ;
...
En contrepartie de l’utilisation des Services, l’Utilisateur cède à l’Editeur, à titre gratuit, ses droits sur ses Commentaires pour les exploitations suivantes :
        ...
        i.           Reproduction, en tout ou partie, de ses Commentaires, leur intégration et communication sur les Site et Applications, accompagnée ou non d’autres Contenus ainsi que leur communication au public par tout support de communication connu ou inconnu à ce jour ;
...
La marque « Public » et le(s) logo(s) associé(s) est une marque protégée en France et à l’étranger. Sauf autorisation expresse et préalable, tout usage de cette marque ainsi que toutes autres marques, figuratives ou non appartenant à l’Editeur, à d’autres sociétés du groupe Lagardère, ou à des tiers, expose l’Utilisateur à des poursuites pénales et/ou civiles.<br><br>
...
L’Editeur et l’Utilisateur acceptent de communiquer principalement par voie électronique. Ces communications électroniques font foi entre l’Editeur et l’Utilisateur et constituent des preuves recevables, valides et opposables. Par ailleurs, l’Editeur et l’Utilisateur attribuent la même valeur probante au fait de cocher la mention « j’ai lu et j’accepte les conditions générales de Public » telle que prévue notamment au sein du formulaire d'inscription au compte Public, qu’à une signature manuscrite.<br><br>

ARTICLE 11 - LOI APPLICABLE ET JUGE COMPETENT

Le non-respect par l’Utilisateur, quelle que soit sa localisation, de l’une quelconque des dispositions des CGU et de façon plus générale toute difficulté touchant à son exécution, son interprétation ou sa validité, sont soumis à la loi française et aux juridictions françaises. </p>
